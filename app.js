...
function Cookie(name, minCust, maxCust, avgPerCust, hourlyCookies, customersEachHour, cookiesEachHour, cookiesPerDay){
  this.name = name;
...
new Cookie('Pike', 23, 65, 6.3, Cookie.hourlyCookies, Cookie.customersEachHour, Cookie.cookiesEachHour, Cookie.cookiesPerDay);
